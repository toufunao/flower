...
adjacency, features, labels, train_mask, val_mask, test_mask = load_data(path="split_cora/cora10/")
...
if __name__ == "__main__":
    ...
    with open(f'log/client10_{args.n}.log', mode='a', encoding='utf-8') as f:
