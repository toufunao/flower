...
adjacency, features, labels, train_mask, val_mask, test_mask = load_data(path="split_data/cora11/")
...
if __name__ == "__main__":
    ...
    if not os.path.exists('log/'):
        os.mkdir('log/')
    with open(f'log/client11_{args.n}.log', mode='w', encoding='utf-8') as f:
