...
adjacency, features, labels, train_mask, val_mask, test_mask = load_data(path="split_data/cora12/")
...
if __name__ == "__main__":
    ...
    if not os.path.exists('log/'):
        os.mkdir('log/')
    with open(f'log/client12_{args.n}.log', mode='w', encoding='utf-8') as f:
