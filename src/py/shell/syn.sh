...
nohup ssh $server "
	...
	python3 server.py --fraction_fit ${fraction_fit} --fraction_eval ${fraction_eval} --min_fit_clients ${min_fit_clients} --min_eval_clients ${min_eval_clients} --min_available_clients ${min_available_clients} --rounds ${rounds} ; echo server is ready;">logs/server.log &
